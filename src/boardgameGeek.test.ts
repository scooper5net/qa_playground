import {
  ...
  class BggPage {
    ...
    headerLogo: By = By.xpath('//img[@alt="boardgame geek logo"]');
    searchBar: By = By.css('input[placeHolder="Search"]');
    gamePageName: By = By.xpath('//div/h1/a');
    gamePageRating: By = By.xpath('//div/overall-rating/div[@class="rating-overall"]');
